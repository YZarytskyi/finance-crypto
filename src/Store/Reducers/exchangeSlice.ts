...
export const fetchExchanges = createAsyncThunk<Array<Exchanges>, number>('exchanges/fetch', async (page = 1) => {
  return (await cryptoApi.getExchanges(page))
})
...
export const fetchExchangeById = createAsyncThunk('exchangeById/fetch', async (id: string) => {
