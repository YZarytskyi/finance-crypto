...
const Exchanges = React.lazy(() => import('pages/Crypto/Exchanges/Exchanges'))
const SelectedExchange = React.lazy(
  () => import('pages/Crypto/Exchanges/SelectedExchange/SelectedExchange'),
)
const Arbitrage = React.lazy(() => import('pages/Crypto/Arbitrage/Arbitrage'))
const Converter = React.lazy(() => import('pages/Crypto/Converter/Converter'))
const SelectedCoin = React.lazy(() => import('pages/Crypto/Coins/SelectedCoin/SelectedCoin'))
        ...
        <Routes>
          <Route path='/' element={<SharedLayout />}>
            ...
            <Route path='crypto' element={<Crypto />}>
              ...
              <Route path='exchanges/:exchangeId' element={<SelectedExchange />} />
